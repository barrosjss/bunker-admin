...
export default function TrainerRoutineDetailPage() {
          ...
          {routine.routine_template_exercises?.map((exercise, index) => (
            <Card key={exercise.id}>
              <div className="flex items-start gap-4">
                <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-success/10 text-success font-bold text-lg">
                  {index + 1}
                </div>
